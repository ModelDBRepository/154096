#!/bin/sh
# Deletion, and default electrostimulation, but only for E2/3

# Set save path
datadir="rowanms-data/neurostim/4localADprosfreq/"

# Set job name
jobname="4localadfreq"
...
args="-c {useprosthesis=1} -c {deleting=1} -c {nproscellpops=1}"
